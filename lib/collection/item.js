...
class Item extends Property {
     ...
     * @returns {Item}
     */
    setProtocolProfileBehavior (key, value) {
     ...
     * @returns {Item}
     */
    unsetProtocolProfileBehavior (key) {
 ...
 * @type {String}
 */
Item._postman_propertyName = 'Item';
