...
class ProxyConfigList extends PropertyList {
    /**
     * @param {Object} parent
    ...
    constructor (parent, populate) {
        ...
        super(ProxyConfig, parent, populate);
    }
 ...
 */
ProxyConfigList._postman_propertyName = 'ProxyConfigList';
